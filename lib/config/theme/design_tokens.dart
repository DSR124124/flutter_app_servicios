  ...
  static EdgeInsets getButtonPadding(ButtonSize size) {
    switch (size) {
      case ButtonSize.small:
        return const EdgeInsets.symmetric(horizontal: 11.2, vertical: 5.6); // 0.35rem 0.7rem
      case ButtonSize.medium:
        return const EdgeInsets.symmetric(horizontal: 16, vertical: 8.8); // 0.55rem 1rem
      case ButtonSize.large:
        return const EdgeInsets.symmetric(horizontal: 20, vertical: 12.8); // 0.8rem 1.25rem
    }
  }
